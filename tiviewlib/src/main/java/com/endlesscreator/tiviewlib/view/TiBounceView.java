...
import com.endlesscreator.tiviewlib.view.model.tibounceview.utils.FastBlur;
import com.endlesscreator.tiviewlib.view.model.tibounceview.utils.ScreenUtils;
...
public class TiBounceView extends RelativeLayout {
    ...
    public TiBounceView(Context context) {
        super(context);
        init();
    }

    public TiBounceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TiBounceView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setBounceBgDrawable(Drawable drawable) {
        if (ivBounceBg != null) {
            if (ivBounceBg instanceof ImageView) {
                ((ImageView) ivBounceBg).setImageDrawable(drawable);
            } else {
    ...
    public void setBounceBgResource(int resId) {
        if (ivBounceBg != null) {
            if (ivBounceBg instanceof ImageView) {
                ((ImageView) ivBounceBg).setImageResource(resId);
            } else {
