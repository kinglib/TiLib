 ...
 */
public class TiWrapLayout extends ViewGroup {
    ...
    public TiWrapLayout(Context context) {
        super(context);
        initView(context, null, 0);
    }

    public TiWrapLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs, 0);
    }

    public TiWrapLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public TiWrapLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        TypedArray custom = context.obtainStyledAttributes(attrs, R.styleable.TiWrapLayout);
        horizontalSpacing = custom.getDimensionPixelSize(
                R.styleable.TiWrapLayout_horizontal_spacing, horizontalSpacing);
        verticalSpacing = custom.getDimensionPixelSize(
                R.styleable.TiWrapLayout_vertical_spacing, verticalSpacing);
        int gravity = custom.getInt(R.styleable.TiWrapLayout_gravity, GRAVITY_TOP);
        custom.recycle();
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        private int mGravity = TiWrapLayout.GRAVITY_PARENT;

        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            int gravity = TiWrapLayout.GRAVITY_PARENT;
            TypedArray custom = c.obtainStyledAttributes(attrs, R.styleable.TiWrapLayout_LayoutParams);
            gravity = custom.getInt(R.styleable.TiWrapLayout_LayoutParams_layout_gravity, gravity);
            custom.recycle();
            mGravity = gravity;
        }
